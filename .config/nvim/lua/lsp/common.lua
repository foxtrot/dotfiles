...
M.on_attach = function(_, bufnr)
  ...
  buf_set_keymap('n', '<leader>ga', '<cmd>Telescope lsp_code_actions<CR>', opts)
  buf_set_keymap('n', '<leader>gd', '<cmd>Telescope lsp_definitions<CR>', opts)
  buf_set_keymap('n', '<leader>ge', '<cmd>lua vim.diagnostic.open_float(0, { scope="line" })<CR>', opts)
  buf_set_keymap('n', '<leader>gx', '<cmd>Telescope diagnostics<CR>', opts)
  buf_set_keymap('n', '<leader>gm', '<cmd>lua vim.lsp.buf.rename()<CR>', opts)
  ...
  buf_set_keymap('n', '<leader>gw', '<cmd>Telescope lsp_dynamic_workspace_symbols<CR>', opts)
end
